...
const ProductSlider = ({data, renderSlide, swiperProps, classes}) => {
  return (
    // <>
    // {data && data.map(({ productName, productBrand,id,productOldPrice,productCurrentPrice,productRating,productInStock }) => (
    //     <SwiperSlide className="w-[290px]" key={id}>
    //         <div

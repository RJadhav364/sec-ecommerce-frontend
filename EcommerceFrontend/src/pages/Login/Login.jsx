                ...
                <div>
                    <div class="form-group w-full mt-5 mb-5 flex flex-col gap-[20px]">
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input type="text" name='email' className='dark:bg-[#111111] bg-[#cccccc] outline-none p-[10px] dark:shadow-[0px_0px_6px_2px_#000] shadow-[0px_0px_6px_2px_#ccc] w-full rounded-md' ref={(e)=>{customerLoginDetails.current.email = e}} />
                        </div>
                        <div class="flex flex-col gap-1.5">
                            <label htmlFor="password">Password</label>
                            <input type="password" name='password' className='dark:bg-[#111111] bg-[#cccccc] outline-none p-[10px] dark:shadow-[0px_0px_6px_2px_#000] shadow-[0px_0px_6px_2px_#ccc] w-full rounded-md' ref={(e)=>{customerLoginDetails.current.password = e}} />
                        </div>
                    </div>
                    <button className='w-full p-2.5 bg-[#ff5252] rounded-md inline-block mt-[10px]' onClick={loginCustomer}>Login</button>
                </div>
            </div>
        </div>
    </section>

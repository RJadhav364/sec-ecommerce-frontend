                                    ...
                                    >
                                        {/* <Link to={`/products/${id}`}> */}
                                            <div className={`group imgWrapper w-[100%]  overflow-hidden  rounded-md rounded-bl-none rounded-br-none relative z-0 ${layoutProduct.setActiveLayout == 2 && "w-[300px] h-[300px]"}`}>
                                                ...
                                                <WishListButtons productIdCom={id} userToWishList={userId} removeFromWishLIst={removeFromWishLIst} addProductInFavourite={addProductInFavourite} isReloginModelOpen={isReloginModelOpen} />
                                                </div>
                                            </div>

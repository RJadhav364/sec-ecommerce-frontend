            ...
            <div className="py-8">
                ...
                <div className="before:contents-[''] before:inline-block before:w-[2px] before:h-full before:bg-[#e3e2e2] before:absolute relative before:right-0 before:rounded-[10px]">
                    ...
                    <input
                        ...
                        className="rounded px-5 py-1 bg-transparent border border-gray-500 placeholder:text-sm mr-5 inline-block dark:placeholder:text-text-color"
                        name="email"
                        id="email"
                    />
                    <button className="dark:text-black text-white dark:bg-white bg-black py-1 px-2 rounded m 2xl:mt-auto xl:mt-auto lg:mt-2 md:mt-auto ">
                        Subscribe
                    </button>
                    </div>
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
                    <div>
                    <p className="font-[600] text-black text-[18px] dark:text-text-color">Most Sold Products</p>
                    ...
                    <div>
                    <p className="font-[600] text-black text-[18px] dark:text-text-color">Useful links</p>
                    ...
                    <div>
                    <p className="font-[600] text-black text-[18px] dark:text-text-color">Follow us</p>
                    <ul className="mt-6 space-y-4 text-sm">
                        <li>
                        <a
                            href="#"
                        ...
                        >
                            ...
                            <span className="flex justify-center ml-3.5 text-sm text-black dark:text-text-color">
                            Facebook
                            </span>
                        </a>
                        </li>
                ...
                <p className="text-xs text-black dark:text-text-color">

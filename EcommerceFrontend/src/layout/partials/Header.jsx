...
const Header = () => {
  return (
    <div className='border-b-[1px] border-[#c1c1c1]'>
      <div className='mx-auto w-[1400px] py-[20px] grid grid-cols-3 items-center'>
        ...
        <div className='flex justify-end gap-[10px]'>
          <div className='flex gap-[8px]'>
            <a href="">Login</a><span className='border-[1px] border-[#968287]'></span><a href="">Register</a>
          </div>
          <button className='cursor-pointer hover:bg-gray-100 p-[5px] rounded-full'>

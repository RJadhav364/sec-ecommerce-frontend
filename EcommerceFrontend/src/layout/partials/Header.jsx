...
const Header = () => {
  ...
  return (
    <div className='border-b-[1px] border-[#c1c1c1] bg-white dark:bg-gray-800'>
      <div className='mx-auto w-[1400px] py-[20px] grid grid-cols-3 items-center'>
        <div><img src="	https://serviceapi.spicezgold.com/download/1744255975457_logo.jpg" alt="" /></div>
          <div>
            {/* empty */}
          </div>
        <div className='flex justify-end gap-[10px]'>
          <div className='flex gap-[8px] items-center'>
            <a href="">Login</a><span className='border-[1px] border-[#968287] h-[60%] inline-block'></span><a href="">Register</a>
          </div>
          <button className='cursor-pointer hover:bg-[#e2dedf] p-[10px] rounded-full'>

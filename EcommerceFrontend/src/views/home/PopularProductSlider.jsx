...
const PopularProductSlider = ({data}) => {
  return (
    <>
    <ProductSlider data={data} swiperProps={{
        slidesPerView : 'auto',
    ...
    renderSlide={({productName, productBrand,id,productOldPrice,productCurrentPrice,productRating,productInStock}) => (
    ...
    <ProductSlider
        ...
        renderSlide={
            ({productName, productBrand,id,productOldPrice,productCurrentPrice,productRating,productInStock}) => (

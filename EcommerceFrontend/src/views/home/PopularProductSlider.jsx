...
import ProductSlider from "../../components/3dProductSlider";
  ...
  return (
    <>
      <ProductSlider
        ...
        classes="mySwiper popularSwiperProduct max-[769px]:hidden"
        renderSlide={({
          productName,
          productBrand,
          id,
          ...
          <SwiperSlide key={id} className="w-[290px]">
            <div className="shadow-lg rounded-md border border-[#efe1e1] dark:border-[#959090] w-[290px] flex-shrink-0">
              <div className="group imgWrapper w-[100%]  overflow-hidden  rounded-md rounded-bl-none rounded-br-none relative">
                <Link to={`products/${id}`} data-discover="true">
                  <div className="img h-[200px] overflow-hidden">
                    <img
                      src={`http://localhost:9000/product/get-product-image/${id}/0`}
                    />
                    <img
                      src={`http://localhost:9000/product/get-product-image/${id}/1`}
                ...
                <div className="actions absolute top-[-20px] right-[5px] z-50 flex items-center gap-2 flex-col w-[50px] transition-all duration-300 group-hover:top-[15px] opacity-0 group-hover:opacity-100">
                  <button
                    className="!w-[35px] !h-[35px] !min-w-[35px] !rounded-full !bg-white text-black hover:!bg-primary css-iyey26 flex justify-center items-center"
                    tabIndex="0"
                    type="button"
                  >
                    <svg
              ...
              <div className="info p-3 py-5 relative pb-[50px] h-[190px] w-full">
                <h6 className="text-[13px] !font-[400]">
                  <span className="link transition-all dark:text-text-color">
                    {productBrand}
                  </span>
                </h6>
      ...
      <ProductSlider
        ...
        classes="mySwiper min-[769px]:hidden max-[769px]:h-[400px]"
        renderSlide={({
          productName,
          productBrand,
          id,
          ...
          <SwiperSlide key={id} className="w-[20rem] h-[20rem]">
            <div className="shadow-lg rounded-md border border-[#efe1e1] dark:border-[#959090] w-[290px] flex-shrink-0">
              <div className="group imgWrapper w-[100%]  overflow-hidden  rounded-md rounded-bl-none rounded-br-none relative">
                <Link to={`products/${id}`} data-discover="true">
                  <div className="img h-[200px] overflow-hidden">
    ...
    className="mySwiper popularSwiperProduct max-[769px]:hidden"
    >
      ...
      {/* <Swiper
        ...
        pagination={{el:"", clickable:true}}
        modules={[EffectCoverflow, Pagination]}
        className="mySwiper min-[769px]:hidden min-[769px]:h-[400px]"
      >
        <ProductSlider data={data} />
      </Swiper> */}
    </>
